...
public final class MyStrategy implements Strategy {
     ...
     */
    private final Map<LaneType, Point2D[]> waypointsByLine = new EnumMap<>(LaneType.class);
    ...
    private void initializeStrategy(Wizard self, Game game) {
        if (random == null) {
            ...
            waypointsByLine.put(LaneType.MIDDLE, new Point2D[]{
            ...
            waypointsByLine.put(LaneType.TOP, new Point2D[]{
                    new Point2D(100.0D, mapSize - 100.0D),
            ...
            waypointsByLine.put(LaneType.BOTTOM, new Point2D[]{
                    new Point2D(100.0D, mapSize - 100.0D),
